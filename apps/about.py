...
def app():
    ...
    We think with help of our data we can figure out if a patient has a heart disease or not. For this we are using Machine Learning and Feature Engineering.
